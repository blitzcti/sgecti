            ...
            <table id="coordinators" class="table table-bordered table-hover">
                ...
                @foreach($coordinators as $coordinator)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.usuario.editar', ['id' => $coordinator->id_user]) }}">{{ App\User::all()->find($coordinator->id_user)->name }}</a>
                        </td>
                        <td>
                            <a href="{{ route('admin.curso.editar', ['id' => $coordinator->id_course]) }}">{{ App\Course::all()->find($coordinator->id_course)->name }}</a>
                        </td>
